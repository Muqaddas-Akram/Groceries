...
function Gradiants() {
  ...
  const products = [
    {
      name: "Paasta",
      image: "src/assets/Images/Home Pics/40.jfif",
      description: "On a recent test run of all three services.",
    },
    {
      name: "Oil",
      image: "src/assets/Images/Home Pics/43.jfif",
      description: "On a recent test run of all three services.",
    },
    {
      name: "Aata",
      image: "src/assets/Images/Home Pics/44.jfif",
      description: "On a recent test run of all three services.",
    },
    {
      name: "Milk",
      image: "src/assets/Images/Home Pics/45.jfif",
      description: "On a recent test run of all three services.",
    },
    {
      name: "Paasta",
      image: "src/assets/Images/Home Pics/42.jpg",
      description: "On a recent test run of all three services.",
    },
  ];
  ...
  const nextSlide = () => {
    setCurrentIndex(
      (prevIndex) => (prevIndex + 1) % Math.ceil(products.length / itemsPerPage)
    );
  };
