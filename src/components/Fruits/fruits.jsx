...
function Fruits() {
  ...
  const products = [
    {
      name: "Banana",
      image: "src/assets/Images/Home Pics/29.jfif",
      description: "On a recent test run of all three services.",
    },
    {
      name: "Peach",
      image: "src/assets/Images/Home Pics/31.jpg",
      description: "On a recent test run of all three services.",
    },
    {
      name: "Mango",
      image: "src/assets/Images/Home Pics/32.jfif",
      description: "On a recent test run of all three services.",
    },
    {
      name: "Orange",
      image: "src/assets/Images/Home Pics/33.jfif",
      description: "On a recent test run of all three services.",
    },
    {
      name: "Grapes",
      image: "src/assets/Images/Home Pics/34.jfif",
      description: "On a recent test run of all three services.",
    },
